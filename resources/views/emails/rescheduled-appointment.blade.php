...
<html>
    <head>
        <title>Intuitive | Confirmación de nueva cita</title>
    </head>
    <body style="background-color: #f6f6f6;">
        ...
        <div style="width: 100%; max-width: 568px; margin: auto; font-family: Calibri, Roboto, sans-serif; color: #85868C; text-align: left; padding: 30px; background-color: #fff;">
            <p style="font-size: 20px; font-weight: 700; margin-bottom: 24px; color: #071BCE; letter-spacing: 1.6px;">CONFIRMACIÓN DE NUEVA CITA</p>
            <p style="font-size: 16px; margin-bottom: 15px;">Hola {{$subscriber->full_name}}, tu cambio de cita se realizó exitosamente. A continuación puedes ver los detalles de tu nueva cita para entrevista:</p>
