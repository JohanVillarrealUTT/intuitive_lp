    ...
    <div>
        ...
        <main>
                ...
                <landing-section>
                    <div class="wrap">
                        <hero-copy>
                            <div class="hero-text">
                                <h2>
                                    REGISTRO DE TÉCNICO DE VACANTES
                                </h2>
                                <h3>
            ...
            <landing-section v-if="$root.enableRegistration">
                <form-wrapper>
                    <vacancy-subscription-form id="registro"></vacancy-subscription-form>
                </form-wrapper>
            </landing-section>
...
import VacancySubscriptionForm from '@/components/website/VacancySubscriptionForm.vue'
